...
const PROXY_URL = import.meta.env.PROD
    ? 'https://clownfish-app-5df7j.ondigitalocean.app/langflow-api'
    : '/langflow-api';

const LANGFLOW_BASE_URL = PROXY_URL;
const LANGFLOW_APP_TOKEN = import.meta.env.VITE_LANGFLOW_APP_TOKEN;
const DEFAULT_FLOW_ID = import.meta.env.VITE_LANGFLOW_FLOW_ID || '070344b2-b674-4f31-80be-3db230cdca20';
...
const langflowClientInstance = new LangflowClient(LANGFLOW_BASE_URL, LANGFLOW_APP_TOKEN);
